import { ProductTestsItem } from '@components/ProductTests';
...
export default async function Home() {
  ...
  return (
    <>
      ...
      <ProductTestsItem rating={1.2} text="ADAC" />
      <ProductTestsItem text="ADAC Segurança" />
      <ProductTestsItem text="Plus Test" plusTest={true} />
      {/* <CardOptionsItems type={'rating'}/> */}
      <br />
      <Icon icon="add_circle" color="m-01" size="16" />
